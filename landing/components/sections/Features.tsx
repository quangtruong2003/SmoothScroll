  ...
  return (
    <section className="py-20 px-4">
      <div className="container">
        ...
        <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 w-full">
          {(f.items ?? []).map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="min-w-0 p-6 rounded-xl border bg-card hover:border-foreground/20 transition-colors text-center"
              >
