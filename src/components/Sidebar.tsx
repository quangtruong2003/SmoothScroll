...
export type TabKey =
  ...
  | "gamemode"
  | "behavior"
  // | "stats"  // Hidden until analytics feature is ready
  | "about";
...
const ALL_TABS: TabDef[] = [
  ...
  // { key: "stats", labelKey: "tabs.stats.label", icon: <BarChart3 className="h-4 w-4" /> },  // Hidden until analytics feature is ready
